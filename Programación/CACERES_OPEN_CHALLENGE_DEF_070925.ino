...
void drive() {  
  ...
  if(CRearSeq>=100) TravelSense=0;                                        //REAR SEQUENCE                                    
  if(CRearSeq>0 && CRearSeq<100) TravelSense=2;
  ...
  if (dServo>=0) ledcWrite(ENA,175+dServo);                               //ADJUST MOTOR SPEED WHEN TURNING
  else ledcWrite(ENA, 175-dServo);    
